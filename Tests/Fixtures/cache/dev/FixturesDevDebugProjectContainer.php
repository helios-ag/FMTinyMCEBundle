...
/**
 * FixturesDevDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class FixturesDevDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fm_tinymce.form.type' => 'getFmTinymce_Form_TypeService',
            'fm_tinymce.templating.helper' => 'getFmTinymce_Templating_HelperService',
            'fm_tinymce.twig_extension' => 'getFmTinymce_TwigExtensionService',
    ...
    /**
     * Gets the 'fm_tinymce.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FM\TinyMCEBundle\Form\Type\TinyMCEType A FM\TinyMCEBundle\Form\Type\TinyMCEType instance.
     */
    protected function getFmTinymce_Form_TypeService()
    {
        return $this->services['fm_tinymce.form.type'] = new \FM\TinyMCEBundle\Form\Type\TinyMCEType(array('instances' => array('default' => array('filebrowser_type' => 'fm_elfinder', 'file_picker_callback' => 'elFinderBrowser', 'filebrowser' => array('route' => 'elfinder', 'route_parameters' => array('instance' => 'tinymce'), 'url' => NULL), 'locale' => 'en_US', 'width' => 600, 'height' => 300, 'theme' => 'modern', 'toolbar_item_size' => 'small', 'menubar' => '"file edit insert view format table tools"', 'image_advtab' => false, 'plugins' => '"advlist autolink lists link image charmap print preview anchor",
        "searchreplace visualblocks code fullscreen",
        "insertdatetime media table contextmenu paste"', 'toolbars' => array())), 'base_path' => '/bundles/fmtinymce/tinymce.min.js'));
    }

    /**
     * Gets the 'fm_tinymce.templating.helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FM\TinyMCEBundle\Templating\TinyMCEHelper A FM\TinyMCEBundle\Templating\TinyMCEHelper instance.
     */
    protected function getFmTinymce_Templating_HelperService()
    {
        return $this->services['fm_tinymce.templating.helper'] = new \FM\TinyMCEBundle\Templating\TinyMCEHelper(array('default' => array('filebrowser_type' => 'fm_elfinder', 'file_picker_callback' => 'elFinderBrowser', 'filebrowser' => array('route' => 'elfinder', 'route_parameters' => array('instance' => 'tinymce'), 'url' => NULL), 'locale' => 'en_US', 'width' => 600, 'height' => 300, 'theme' => 'modern', 'toolbar_item_size' => 'small', 'menubar' => '"file edit insert view format table tools"', 'image_advtab' => false, 'plugins' => '"advlist autolink lists link image charmap print preview anchor",
        "searchreplace visualblocks code fullscreen",
        "insertdatetime media table contextmenu paste"', 'toolbars' => array())), $this->get('router'), $this->get('assets.packages'));
    }

    /**
     * Gets the 'fm_tinymce.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FM\TinyMCEBundle\Twig\TinyMCEExtension A FM\TinyMCEBundle\Twig\TinyMCEExtension instance.
     */
    protected function getFmTinymce_TwigExtensionService()
    {
        return $this->services['fm_tinymce.twig_extension'] = new \FM\TinyMCEBundle\Twig\TinyMCEExtension($this->get('fm_tinymce.templating.helper'));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, NULL, array('cache_dir' => __DIR__, 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'FixturesDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'FixturesDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('fm_tinymce.twig_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/helios/sites/symfony/test27.dev/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/helios/sites/symfony/test27.dev/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath(($this->targetDirs[4].'/Resources/views'), 'FMTinyMCE');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FMTinyMCEBundle' => 'FM\\TinyMCEBundle\\FMTinyMCEBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'FixturesDevDebugProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'FixturesDevUrlMatcher',
            'router.options.generator.cache_class' => 'FixturesDevUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => NULL,
            'router.cache_class_prefix' => 'FixturesDev',
            ...
            'debug.container.dump' => (__DIR__.'/FixturesDevDebugProjectContainer.xml'),
            ...
            'twig.form.resources' => array(
                0 => 'FMTinyMCEBundle:Form:tinymce_widget.html.twig',
        ...
        "insertdatetime media table contextmenu paste"',
                ...
                'base_path' => '/bundles/fmtinymce/tinymce.min.js',
            ),
            'fm_tinymce.instances' => array(
                'default' => array(
                    'filebrowser_type' => 'fm_elfinder',
                    'file_picker_callback' => 'elFinderBrowser',
                    'filebrowser' => array(
