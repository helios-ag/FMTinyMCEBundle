...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->children()
                ->scalarNode('base_path')->defaultValue('/bundles/fmtinymce/tinymce.min.js')->end()
                ->arrayNode('instances')
                    ->isRequired()
                    ...
                    ->prototype('array')
                        ->children()
                            ...
                            ->integerNode('height')->defaultValue(300)->end()
                            ...
                            ->scalarNode('filebrowser_type')->defaultValue('')->end()
